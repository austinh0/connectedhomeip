...
public class ChipDeviceController {
  ...
  /**
   * Indicate that operational discovery of a device is complete, kicking off connection to the
   * device.
   */
  public void onOperationalDiscoveryComplete(long nodeId) {
    onOperationalDiscoveryComplete(deviceControllerPtr, nodeId);
  }
  ...
  private native void onOperationalDiscoveryComplete(long deviceControllerPtr, long nodeId);
